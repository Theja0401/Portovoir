...
.projectstatus td input{
	display: inline-block;
}

.inputstatus input[type="radio"] {
	display: none;
}
...
.inputstatus input[type="radio"]:checked+label {
	background-color: #7C83FD;
}

.inputstatus input[type="radio"]:hover+label {
	background-color: #7C83FD;
}
	...
	<div class="darkmodeflag body">
			...
			<div id="slideshowimg" class="slideshowimg">
				<div id="imgs" class="imgs">
					<div class="imgcontainer">
						<img class="imgpreview" src="{{url('img/preview.png')}}">
					</div>
					<div class="imgcontainer">
						<img class="imgpreview" src="{{url('img/preview.png')}}">
					</div>
		...
		<div class="filldetails">
			<div class="toppart">
				<div class="leftside">
					<div class="postingdetails">
						<h2 class="darkmodeflag texts">Project Details</h2>
						<table>
							<tr class="projecttitle">
								<td class="darkmodeflag texts paddingbottom">Project Title</td>
								<td class="paddingbottom"><input class="darkmodeflag texts" type="text" name="title" placeholder="Input your title here"></td>
							</tr>
							<tr>
								<td class="darkmodeflag texts paddingbottom tdtitle">Project Description</td>
							...
							<tr class="projectstatus">
								<td class="darkmodeflag texts archivetext paddingbottom">Project Status</td>
								<td class="paddingbottom">
									<div class="inputstatus">
										<input type="radio" id="radio1" name="status" value="completed" checked>
										<label class="darkmodeflag texts" for="radio1">Completed</label>

										<input type="radio" id="radio2" name="status" value="ongoing">
										<label class="darkmodeflag texts" for="radio2">Ongoing</label>

										<input type="radio" id="radio3" name="status" value="onhold">
										<label class="darkmodeflag texts" for="radio3">On Hold</label>
									</div>
								</td>
							</tr>
							<tr class="startingdate">
								<td class="paddingbottom darkmodeflag texts archivetext">Project Starting Date</td>
								<td class="paddingbottom">
									<input id="inputdate" class="darkmodeflag texts" type="date" name="date">
								</td>
							</tr>
							<tr class="archive">
								<td class="darkmodeflag texts archivetext">Archive this project?</td>
								<td>
									<label class="switch">
				...
				<div class="rightside">
					<h2 class="darkmodeflag texts">Project Genres</h2>
			...
			<div class="bottompart">
				<h2 class="darkmodeflag texts">Upload Image Files</h2>
				<div class="bottompartflex">
					<div class="postimage">
						<div class="postimageflex">
							<input id="inputreadonly" class="darkmodeflag inputreadonly" type="text" placeholder="Insert your first image using the button on the right" readonly>
							<label class="inputfile">
							    <input type="file" name="uploadpost" onchange="setfilename(this.value, 0)">
							    <img src="{{url('img/folder.png')}}">
							</label>
						</div>
						<div class="postimageflex">
							<input id="inputreadonly" class="darkmodeflag inputreadonly" type="text" placeholder="Insert your second image using the button on the right (optional)" readonly>
							<label class="inputfile">
							    <input type="file" name="uploadpost" onchange="setfilename(this.value, 1)">
							    <img src="{{url('img/folder.png')}}">
							</label>
						</div>
						<div class="postimageflex">
							<input id="inputreadonly" class="darkmodeflag inputreadonly" type="text" placeholder="Insert your third image using the button on the right (optional)" readonly>
							<label class="inputfile">
							    <input type="file" name="uploadpost" onchange="setfilename(this.value, 2)">
							    <img src="{{url('img/folder.png')}}">
							</label>
						</div>
						<div class="postimageflex">
							<input id="inputreadonly" class="darkmodeflag inputreadonly" type="text" placeholder="Insert your fourth image using the button on the right (optional)" readonly>
							<label class="inputfile">
							    <input type="file" name="uploadpost" onchange="setfilename(this.value, 3)">
							    <img src="{{url('img/folder.png')}}">
							</label>
						</div>
						<div class="postimageflex">
							<input id="inputreadonly" class="darkmodeflag inputreadonly" type="text" placeholder="Insert your fifth image using the button on the right (optional)" readonly>
							<label class="inputfile">
							    <input type="file" name="uploadpost" onchange="setfilename(this.value, 4)">
							    <img src="{{url('img/folder.png')}}">
							</label>
						</div>
						<div class="warning">
							<img src="{{url('img/chat.png')}}">
							<p>Posting several images are optional as they will be used for the project preview</p>
						</div>
					</div>
...
function setfilename(filename, number){
	f = filename.replace(/.*[\/\\]/, '')
	document.getElementsByClassName('inputreadonly')[number].value = f;
	document.getElementsByClassName('imgpreview')[number].src = f;
}
